...
import { login, otpLogin, directLogin, directRegister, sendOtp, register, getProfile, changePassword, getAllUsers, getAllAdmins, deleteUser, deleteAdmin, updateProfile } from '../controllers/authController.js';
